import logging
# logging.basicConfig(level=logging.DEBUG, filename="DebugDemo.log", filemode="w")
# logging.basicConfig(filename="DebugDemo.log", filemode="w")
logging.basicConfig(filename="DebugDemo.log", filemode="a")
class DemoLogging:
